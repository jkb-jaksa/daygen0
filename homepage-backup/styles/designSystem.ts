...
export const text = {
  heroHeading: "text-6xl font-normal tracking-tight leading-[1.1] font-raleway",
...
const glassCore = "glass-liquid willchange-backdrop isolate backdrop-blur-2xl border border-d-dark";
