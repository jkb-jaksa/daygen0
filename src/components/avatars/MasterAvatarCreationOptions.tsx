...
export interface MasterAvatarCreationOptionsProps {
...
function MasterAvatarCreationOptionsComponent({
  selection,
  uploadError,
  isDragging,
  avatarName,
...
export const MasterAvatarCreationOptions = memo(MasterAvatarCreationOptionsComponent);

export default MasterAvatarCreationOptions;
