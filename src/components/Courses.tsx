      ...
      <section className="relative z-10 py-12 sm:py-16 lg:py-20">
        <div className={`${layout.container}`}>
          ...
          <header className="mb-6">
            ...
            <h1 className={`${textStyles.sectionHeading} mt-3 text-3xl sm:text-4xl text-d-text`}>Courses</h1>
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            ...
            <div className="flex-1">
              <div className={`${glass.surface} rounded-3xl border-d-dark px-6 pt-2 pb-6 sm:px-8 sm:pt-4 sm:pb-8`}
                ...
                <h2 className="text-xl font-raleway font-light text-d-text">Courses</h2>
