...
const VIDEO_TOOLS: Tool[] = [
  ...
  { name: "Luma Ray", desc: "High-quality video generation with Ray 2.", Icon: Sparkles, accent: "cyan", href: "/ai-tools/tools" },
  ...
  { name: "Seedance", desc: "Great quality text-to-image.", Icon: Leaf, accent: "emerald", href: "/ai-tools/tools" },
            ...
            {CATEGORIES.map(({ label, Icon }) => {
              ...
              return (
                <button
                  ...
                  className={cx(
                    "group flex items-center gap-2 transition duration-200 cursor-pointer text-base font-raleway font-normal appearance-none bg-transparent p-0 m-0 border-0 text-left focus:outline-none focus:ring-0",
