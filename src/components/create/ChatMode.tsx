                            ...
                            <div className="relative z-10 flex items-center justify-between gap-2">
                              ...
                              <div className="flex items-center gap-1">
                                <button
                                  ...
                                  className={`grid size-6 place-items-center rounded-full opacity-0 transition-opacity duration-150 group-hover:opacity-100 ${isActive ? "text-theme-white hover:text-theme-text" : "text-theme-light hover:text-theme-text"
                                    }`}
                                  ...
                                  return (
                                    ...
                                    >
                                      <button
                                        ...
                                        className={`flex flex-1 items-center gap-3 ${isActive ? "text-theme-text" : "text-theme-white"
                                          }`}
                                      >
                                        <img
                                          src={avatar.imageUrl}
