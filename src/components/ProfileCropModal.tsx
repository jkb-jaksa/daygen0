...
export default function ProfileCropModal({ isOpen, onClose, imageSrc, onCropComplete }: ProfileCropModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-black/80 flex items-center justify-center p-4">
      <div className="willchange-backdrop isolate bg-d-dark/50 backdrop-blur-[72px] backdrop-brightness-[.85] backdrop-contrast-[1.05] backdrop-saturate-[.85] border border-d-dark rounded-[20px] p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden">
